...
const PortfolioProjectPage: React.FC = () => {
  ...
  const title = "FACE OF ADVERSITY";
  const credit = "Credit: Production Designer";
  const btsImages = [ 
    "/images/portfolio/FOA/bts-1.jpg",
    "/images/portfolio/FOA/bts-2.jpg",
    "/images/portfolio/FOA/bts-3.jpg",
    "/images/portfolio/FOA/bts-4.jpg",
    "/images/portfolio/FOA/bts-5.jpg",
    "/images/portfolio/FOA/bts-6.jpg",
